...
const SchoolLifePage = () => {
  ...
  const lifeImage = getImageForSection(school, 'life', '/pictures/image.jpg');
  ...
  return (
    <div>
      {/* Hero Image Section */}
      {school.sections.lifeHero && (
      <section className="hero-image-section" style={{height: '60vh', overflow: 'hidden'}}>
        <img 
          src={getImageForSection(school, 'life', '/pictures/image.jpg')} 
      ...
      {school.sections.clubActivities && (
      ...
      {school.sections.lifeSection && <LifeSection schoolData={school} />}
      {school.sections.popularEvents && <PopularEvents schoolData={school} />}
      {school.sections.achieversSection && <AchieversSection schoolData={school} />}
    </div>
  );
};
