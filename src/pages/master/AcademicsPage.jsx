...
const AcademicsPage = ({ schoolData }) => {
  return (
    <div className="academics-page">
      <Hero image={getImageForSection(schoolData, 'academics', '/pictures/image.jpg')} alt={schoolData ? `${schoolData.name} Academics` : 'TIGPS Academics'} />
